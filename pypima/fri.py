...
SNR_LIMITS = {
    ...
    # 18724 points
    ('l', 64, 1, 285): PFDRec(5.32, 5.70, 6.05, 6.39, 5.877e+04, 1.194),

    # ("l", 64, 1.0, 570): [5.5, 5.9, 6.2, 6.6],
    # 4860 points
    ('l', 64, 1, 570): PFDRec(5.49, 5.83, 6.15, 6.45, 8.305e+05, 1.140),

    # ("l", 64, 1.0, 870): [5.6, 6.0, 6.3, 6.7],
    # 2678 points
    ('l', 64, 1, 870): PFDRec(5.65, 5.98, 6.30, 6.59, 2.010e+06, 1.146),

    # ("l", 64, 1.0, 1170): [5.7, 6.1, 6.4, 6.7],
    # 1203 points
    ('l', 64, 1, 1170): PFDRec(5.74, 6.06, 6.36, 6.65, 6.254e+06, 1.130),

    # ("l", 2048, 0.25, 285): [5.7, 6.0, 6.4, 6.7],
    # 12384 points
    ('l', 2048, 0.25, 285): PFDRec(5.85, 6.21, 6.55, 6.87, 1.004e+06, 1.209),

    # ("l", 2048, 0.25, 570): [5.9, 6.2, 6.6, 6.9],
    # 12216 points
    ('l', 2048, 0.25, 570): PFDRec(6.09, 6.42, 6.75, 7.05, 5.887e+06, 1.200),

    # ("l", 2048, 0.25, 870): [6.1, 6.5, 6.9, 7.2],
    # 12250 points
    ('l', 2048, 0.25, 870): PFDRec(6.21, 6.54, 6.85, 7.15, 1.883e+07, 1.191),

    # ("l", 2048, 0.25, 1170): [6.1, 6.5, 6.8, 7.1],
    # 3112 points
    ('l', 2048, 0.25, 1170): PFDRec(6.28, 6.59, 6.89, 7.18, 6.125e+07, 1.172),

    # C-band
    # ("c", 64, 0.5, 285): [5.2, 5.6, 6.0, 6.3],
    # 31361 points
    ('c', 64, 0.5, 285): PFDRec(5.24, 5.62, 5.97, 6.30, 5.523e+04, 1.179),

    # ("c", 64, 0.5, 570): [5.4, 5.8, 6.1, 6.5],
    # 7766 points
    ('c', 64, 0.5, 570): PFDRec(5.39, 5.72, 6.03, 6.32, 1.230e+06, 1.108),

    # ("c", 64, 0.5, 870): [5.6, 5.9, 6.2, 6.6],
    # 4488 points
    ('c', 64, 0.5, 870): PFDRec(5.57, 5.90, 6.21, 6.50, 1.742e+06, 1.133),

    # ("c", 64, 0.5, 1170): [5.7, 6.0, 6.3, 6.6],
    # 1626 points
    ('c', 64, 0.5, 1170): PFDRec(5.70, 6.04, 6.35, 6.65, 2.156e+06, 1.154),

    # ("c", 256, 0.5, 285.0): [5.4, 5.7, 6.0, 6.3],  # 478 points
    # 1299 points
    ('c', 256, 0.5, 285): PFDRec(5.36, 5.68, 6.00, 6.29, 8.022e+05, 1.113),

    # ("c", 256, 0.5, 570): [5.6, 5.9, 6.2, 6.5],  # 229 points
    # 548 points
    ('c', 256, 0.5, 570): PFDRec(5.53, 5.83, 6.11, 6.38, 1.223e+07, 1.071),

    # ("c", 2048, 0.125, 285): [5.8, 6.1, 6.5, 6.8],
    # 18883 points
    ('c', 2048, 0.125, 285): PFDRec(5.81, 6.16, 6.49, 6.80, 1.154e+06, 1.194),

    # ("c", 2048, 0.125, 570): [6.1, 6.4, 6.7, 7.0],
    # 19157 points
    ('c', 2048, 0.125, 570): PFDRec(6.01, 6.34, 6.65, 6.95, 8.163e+06, 1.177),

    # ("c", 2048, 0.125, 870): [6.2, 6.5, 6.8, 7.1],
    # 16650 points
    ('c', 2048, 0.125, 870): PFDRec(6.13, 6.45, 6.75, 7.04, 2.879e+07, 1.165),

    # ("c", 2048, 0.125, 1170): [6.3, 6.6, 6.9, 7.2],
    # 4796 points
    ('c', 2048, 0.125, 1170): PFDRec(6.24, 6.55, 6.85, 7.14, 4.982e+07, 1.170),
    ...
    # 4465 points
    ('k', 64, 0.125, 285): PFDRec(5.45, 5.79, 6.11, 6.41, 7.125e+05, 1.136),

    # ("k", 64, 0.125, 570): [5.8, 6.1, 6.4, 6.7],
    # 1276 points
    ('k', 64, 0.125, 570): PFDRec(5.70, 6.02, 6.34, 6.63, 2.884e+06, 1.144),

    # ("k", 64, 0.125, 870): [5.9, 6.3, 6.6, 6.9],
    # 542 points
    ('k', 64, 0.125, 870): PFDRec(5.89, 6.23, 6.54, 6.84, 4.311e+06, 1.171),

    # ("k", 64, 0.125, 1170): [6.0, 6.3, 6.7, 7.0],
    # 175 points
    ('k', 64, 0.125, 1170): PFDRec(5.90, 6.20, 6.48, 6.76, 4.536e+07, 1.109),

    # ("k", 256, 0.5, 285): [5.5, 5.8, 6.1, 6.5],  # 379 points
    # 973 points
    ('k', 256, 0.5, 285): PFDRec(5.42, 5.74, 6.04, 6.33, 2.007e+06, 1.099),

    # ("k", 256, 0.5, 570): [5.6, 5.8, 6.2, 6.5],  # 190 points
    # 538 points
    ('k', 256, 0.5, 570): PFDRec(5.68, 5.99, 6.29, 6.58, 5.974e+06, 1.120),

    # ("k", 2048, 0.125, 285): [6.0, 6.3, 6.6, 6.9],  # 17893 points
    # 9833 points
    ('k', 2048, 0.125, 285): PFDRec(5.86, 6.19, 6.50, 6.80, 5.014e+06, 1.161),

    # ("k", 2048, 0.125, 570): [6.2, 6.5, 6.8, 7.1],  # 10867 points
    # 7217 points
    ('k', 2048, 0.125, 570): PFDRec(6.09, 6.40, 6.70, 6.99, 3.037e+07, 1.155),

    # ("k", 2048, 0.125, 870): [6.3, 6.6, 6.9, 7.2],  # 5131 points
    # 5018 points
    ('k', 2048, 0.125, 870): PFDRec(6.22, 6.54, 6.83, 7.12, 5.739e+07, 1.164),

    # ("k", 2048, 0.125, 1170): [6.4, 6.7, 7.0, 7.3],  # 595 points
    # 863 points
    ('k', 2048, 0.125, 1170): PFDRec(6.32, 6.63, 6.92, 7.21, 1.004e+08, 1.167),
