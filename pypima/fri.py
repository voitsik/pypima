...
SNR_LIMITS = {
    ...
    # Copy from C-band
    ("l", 64, 0.5, 285): PFDRec(5.24, 5.62, 5.97, 6.30, 5.523e04, 1.179),
    ("l", 64, 0.5, 570): PFDRec(5.39, 5.72, 6.03, 6.32, 1.230e06, 1.108),
    ("l", 64, 0.5, 870): PFDRec(5.57, 5.90, 6.21, 6.50, 1.742e06, 1.133),
    ("l", 64, 0.5, 1170): PFDRec(5.70, 6.04, 6.35, 6.65, 2.156e06, 1.154),
    ("l", 64, 0.25, 570): PFDRec(5.70, 6.04, 6.35, 6.65, 2.156e06, 1.154),
    ("l", 64, 0.25, 1170): PFDRec(5.70, 6.04, 6.35, 6.65, 2.156e06, 1.154),
    # 4468 points, K-band used
    ("l", 64, 0.125, 285): PFDRec(5.44, 5.78, 6.10, 6.40, 7.892e05, 1.132),
    # 1279 points, K-band used
    ("l", 64, 0.125, 570): PFDRec(5.70, 6.03, 6.34, 6.64, 2.715e06, 1.147),
    # 542 points, K-band used
    ("l", 64, 0.125, 870): PFDRec(5.88, 6.21, 6.52, 6.82, 5.430e06, 1.163),
    # 171 points, K-band used
    ("l", 64, 0.125, 1170): PFDRec(5.91, 6.22, 6.51, 6.79, 3.010e07, 1.122),
    # 12384 points
    ...
    # Just copy of ("l", 2048, 0.25, 870)
    ("l", 2048, 1.0, 870): PFDRec(6.21, 6.54, 6.85, 7.15, 1.883e07, 1.191),
    # Just copy of ("l", 2048, 0.25, 1170)
    ("l", 2048, 0.5, 1170): PFDRec(6.28, 6.59, 6.89, 7.18, 6.125e07, 1.172),
    #
    # C-band
    #
    ...
    # 30 points
    ("c", 64, 1, 285): PFDRec(5.02, 5.36, 5.68, 5.99, 1.148e05, 1.103),
    ...
    # Just copy of ("c", 256, 0.5, 570)
    ("c", 256, 0.5, 870): PFDRec(5.53, 5.83, 6.11, 6.38, 1.223e07, 1.071),
    ...
    # 28 points
    ("c", 2048, 0.25, 870): PFDRec(6.06, 6.41, 6.74, 7.06, 2.444e06, 1.222),
    # 4 points
    ("c", 2048, 0.25, 570): PFDRec(6.08, 6.38, 6.67, 6.94, 6.887e07, 1.131),
    # Copy from K-band
    ...
    # 115 points
    ("k", 64, 0.5, 285): PFDRec(5.19, 5.51, 5.81, 6.10, 8.050e05, 1.078),
    # 18 points
    ("k", 64, 0.5, 570): PFDRec(5.42, 5.71, 5.99, 6.25, 1.135e07, 1.052),
    # 26 points
    ("k", 64, 0.5, 870): PFDRec(5.96, 6.38, 6.77, 7.15, 7.621e04, 1.328),
    ("k", 64, 0.5, 1170): PFDRec(5.96, 6.38, 6.77, 7.15, 7.621e04, 1.328),
    # 973 points
