...
SNR_LIMITS = {
    ...
    ('l', 64, 0.125, 1170): PFDRec(5.91, 6.21, 6.50, 6.77, 3.752e+07, 1.115),
    # 12384 points
    ...
    # 30 points
    ('c', 64, 1, 285): PFDRec(5.02, 5.36, 5.68, 5.99, 1.148e+05, 1.103),
    ...
    # 28 points
    ('c', 2048, 0.25, 870): PFDRec(6.06, 6.41, 6.74, 7.06, 2.444e+06, 1.222),
    # 4 points
    ('c', 2048, 0.25, 570): PFDRec(6.08, 6.38, 6.67, 6.94, 6.887e+07, 1.131),
    # Copy from K-band
    ...
    # 115 points
    ('k', 64, 0.5, 285): PFDRec(5.19, 5.51, 5.81, 6.10, 8.050e+05, 1.078),
    # 18 points
