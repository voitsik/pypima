...
SNR_LIMITS = {
    ...
    # 161 points
    ('l', 2048, 0.125, 570): PFDRec(6.18, 6.52, 6.85, 7.17, 4.567e+06, 1.226),

    # 64 points
    ('l', 2048, 0.125, 870): PFDRec(6.37, 6.72, 7.05, 7.37, 6.604e+06, 1.252),

    # 30 points
    ('l', 2048, 0.125, 1170): PFDRec(6.32, 6.61, 6.88, 7.15, 4.911e+08, 1.129),
    ...
    # 12 points
    ('c', 2048, 0.5, 1170): PFDRec(6.01, 6.28, 6.54, 6.78, 1.097e+09, 1.057),
    ...
    # 14 points
    ('k', 2048, 0.015625, 870): PFDRec(6.48, 6.83, 7.15, 7.46, 1.797e+07, 1.245),
