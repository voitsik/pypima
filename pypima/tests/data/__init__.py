...
SAMPLE_RA_FITS = {
    ("raes03eo", "l"): _full_path(
        "RADIOASTRON_RAES03EO_L_20121016T100000_ASC_V3.idifits"
    ),
    ("raks16nq", "c"): _full_path(
        "RADIOASTRON_RAKS16NQ_C_20170322T020000_ASC_V1.idifits"
    ),
}
...
SAMPLE_RA_CNT = {
    ("raes03eo", "l"): _full_path("raes03eo_l_pima.cnt"),
...
SAMPLE_SCF = {
    "raes03eo": _full_path("RA121015_2100_v02.scf"),
...
SAMPLE_FRI = {
    ("raes03eo", "l"): _full_path("raes03eo_l_RR.fri"),
    ("raes03eo", "l", "nobps"): _full_path("raes03eo_l_RR_nobps.fri"),
    ("raks16nq", "c"): _full_path("raks16nq_c_LL.fri"),
    ("raks16nq", "c", "nobps"): _full_path("raks16nq_c_LL_nobps.fri"),
}
